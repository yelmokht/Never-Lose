// ======================================================================
// Never Lose.v generated from TopDesign.cysch
// 05/19/2023 at 12:06
...
module ADC_DelSig_v3_30_3 (
	...
	cy_clock_v1_0
		#(.id("5819d819-0832-4dac-bc5a-5384a3303fb4/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("5819d819-0832-4dac-bc5a-5384a3303fb4/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1562500000"),
		  .is_direct(0),
...
module CharLCD_v2_20_4 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("0c3cafdc-1418-450e-9854-42b2df3c22d7/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__SW_2_net;
	wire [0:0] tmpIO_0__SW_2_net;
	wire [0:0] tmpINTERRUPT_0__SW_2_net;
	electrical [0:0] tmpSIOVREF__SW_2_net;

	cy_psoc3_pins_v1_10
		#(.id("64e470a4-646a-4d2d-9dc1-93244987b377"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SW_2
		 (.oe(tmpOE__SW_2_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__SW_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SW_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("94a1c769-8976-4304-9bfe-bc8a335acf5e"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__SW_4_net;
	wire [0:0] tmpIO_0__SW_4_net;
	wire [0:0] tmpINTERRUPT_0__SW_4_net;
	electrical [0:0] tmpSIOVREF__SW_4_net;

	cy_psoc3_pins_v1_10
		#(.id("b5bba62e-c26c-4eed-83bb-0871f3596ed0"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SW_4
		 (.oe(tmpOE__SW_4_net),
		  .y({1'b0}),
		  .fb({Net_7}),
		  .io({tmpIO_0__SW_4_net[0:0]}),
		  .siovref(tmpSIOVREF__SW_4_net),
		  .interrupt({tmpINTERRUPT_0__SW_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SW_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("a9aff3aa-60df-424f-bcab-54f8f1e5cc5c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("53bec92d-83fe-4429-94c8-ae63af32b6e1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("68b3f582-e7f6-454e-a505-56222273a2b9"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(10),
		  .period("0"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__SM_1_net;
	wire [0:0] tmpFB_0__SM_1_net;
	wire [0:0] tmpIO_0__SM_1_net;
	wire [0:0] tmpINTERRUPT_0__SM_1_net;
	electrical [0:0] tmpSIOVREF__SM_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		SM_1
		 (.oe(tmpOE__SM_1_net),
		  .y({Net_63}),
		  .fb({tmpFB_0__SM_1_net[0:0]}),
		  .io({tmpIO_0__SM_1_net[0:0]}),
		  .siovref(tmpSIOVREF__SM_1_net),
		  .interrupt({tmpINTERRUPT_0__SM_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SM_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SM_2_net;
	wire [0:0] tmpFB_0__SM_2_net;
	wire [0:0] tmpIO_0__SM_2_net;
	wire [0:0] tmpINTERRUPT_0__SM_2_net;
	electrical [0:0] tmpSIOVREF__SM_2_net;

	cy_psoc3_pins_v1_10
		#(.id("aacf1f8b-7681-41a5-b63c-f6b9b3374fb5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SM_2
		 (.oe(tmpOE__SM_2_net),
		  .y({Net_76}),
		  .fb({tmpFB_0__SM_2_net[0:0]}),
		  .io({tmpIO_0__SM_2_net[0:0]}),
		  .siovref(tmpSIOVREF__SM_2_net),
		  .interrupt({tmpINTERRUPT_0__SM_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SM_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("f5205884-e03a-465f-b00f-dc52b154fc74"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3b28329f-3494-402d-b6d1-14cfeacf0dd3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__PR_1_net;
	wire [0:0] tmpFB_0__PR_1_net;
	wire [0:0] tmpIO_0__PR_1_net;
	wire [0:0] tmpINTERRUPT_0__PR_1_net;
	electrical [0:0] tmpSIOVREF__PR_1_net;

	cy_psoc3_pins_v1_10
		#(.id("bc7a6cdc-2ee7-409d-8ba7-ce79a74ed444"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		PR_1
		 (.oe(tmpOE__PR_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PR_1_net[0:0]}),
		  .analog({Net_1092}),
		  .io({tmpIO_0__PR_1_net[0:0]}),
		  .siovref(tmpSIOVREF__PR_1_net),
		  .interrupt({tmpINTERRUPT_0__PR_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PR_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PR_2_net;
	wire [0:0] tmpFB_0__PR_2_net;
	wire [0:0] tmpIO_0__PR_2_net;
	wire [0:0] tmpINTERRUPT_0__PR_2_net;
	electrical [0:0] tmpSIOVREF__PR_2_net;

	cy_psoc3_pins_v1_10
		#(.id("44e923f3-f596-4fb1-b3ac-4b8fe74cd9ef"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		PR_2
		 (.oe(tmpOE__PR_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PR_2_net[0:0]}),
		  .analog({Net_1093}),
		  .io({tmpIO_0__PR_2_net[0:0]}),
		  .siovref(tmpSIOVREF__PR_2_net),
		  .interrupt({tmpINTERRUPT_0__PR_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PR_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("749832e1-3256-4684-8fe5-72375f279ed0"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("086d0485-986e-4a14-b946-93aab3637152"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("07a1ddb9-1e6e-42df-999c-9223337dbc64"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a97c8b0c-16e4-4dd8-a7ad-c7fed125fd41"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fc673b60-9986-435f-9da9-815f796cb7b9"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("525a2a42-4fd4-4848-af41-5f9cc5badbbd"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4883aba7-8760-443d-9766-066d26b78a60"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
